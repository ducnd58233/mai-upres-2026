...
class DIV2KPairX3(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        # Align HR size to LR*scale (if mismatch slightly)
        ...
        if self.return_meta:
            meta: Dict[str, Any] = {"stem": stem, "x": x, "y": y, "ps": ps, "scale": self.scale}
...
def resolve_div2k_paths(data_root: str, scale: int = 3):
    """
    Supports both:
      - DIV2K_train_LR_bicubic_X3 (your folder)
      - DIV2K_train_LR_bicubic/X3 (classic)
    Same for valid.
    """
